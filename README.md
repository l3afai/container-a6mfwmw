...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a6mfwmw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a6mfwmw.containers.anotherwebservice.com/
...
```
git clone git@github.com:l3afai/container-a6mfwmw.git
cd container-a6mfwmw
```
...
```
docker attach container-a6mfwmw
```
